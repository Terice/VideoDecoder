...
//int* to zig_zag matrix
uint8_t Inverse4x4ZigZag[16][2] = {{0,0}, {0,1}, {1,0}, {2,0}, {1,1}, {0,2}, {0,3}, {1,2}, {2,1}, {3,0}, {3,1}, {2,2}, {1,3}, {2,3}, {3,2}, {3,3}};
//
matrix Inverse4x4Scan(int* res)
{
    uint8_t r = 0, c = 0;
    matrix dst(4,4,0);
...
void residual::Decode_Intra4x4()
{
    ...
    for (uint8_t i8x8 = 0; i8x8 < 4; i8x8++)
    {
        ...
        {
            matrix c(4,4,0);
            c = Inverse4x4Scan(luma[0]->get_childBlock(i8x8)->get_childBlock(i4x4)->value);
